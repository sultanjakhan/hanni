...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands_flywheel::get_adapter_status,
            commands_flywheel::run_finetune,
            commands_flywheel::rate_message,
            commands_flywheel::get_message_ratings,
            // Actions
            macos::run_shell,
            macos::open_url,
            ...
            // Workouts (Sports)
            commands_sports::create_workout,
            commands_sports::get_workouts,
            commands_sports::get_workout_stats,
            commands_sports::delete_workout,
            commands_sports::update_workout,
            // Exercise Catalog
            commands_sports::get_exercise_catalog,
            commands_sports::get_exercise_facets,
            commands_sports::add_exercise_to_catalog,
            commands_sports::update_exercise_catalog,
            commands_sports::delete_exercise_catalog,
            // Workout Templates
            commands_sports::create_workout_template,
            commands_sports::get_workout_templates,
            commands_sports::get_workout_template,
            commands_sports::delete_workout_template,
            commands_sports::toggle_favorite_template,
            commands_sports::create_workout_from_template,
            // Workout Programs
            ...
            // Activity tracking
            commands_flywheel::get_activity_timeline,
            commands_flywheel::get_activity_weekly,
            // Memory browser
            ...
            // Food
            commands_food::log_food,
            commands_food::get_food_log,
            commands_food::delete_food_entry,
            commands_food::update_food_entry,
            commands_food::get_food_stats,
            commands_food::create_recipe,
            commands_food::get_recipes,
            commands_food::update_recipe,
            commands_food::delete_recipe,
            commands_food::duplicate_recipe,
            commands_food::get_ingredient_catalog,
            commands_food::add_ingredient_to_catalog,
            commands_food::update_ingredient_in_catalog,
            commands_food::list_catalog_subgroups,
            commands_food::delete_ingredient_from_catalog,
            commands_food::check_ingredient_usage,
            commands_food::list_food_blacklist,
            commands_food::add_food_blacklist,
            commands_food::remove_food_blacklist,
            commands_food::find_recipes_matching_blacklist,
            commands_food::delete_recipes_matching_blacklist,
            commands_food::get_cuisines,
            commands_food::add_cuisine,
            commands_food::toggle_favorite_recipe,
            commands_food::mark_recipe_cooked,
            commands_food::log_cooking,
            commands_food::get_cooking_log,
            ...
            commands_food::add_product,
            commands_food::get_products,
            commands_food::update_product,
            commands_food::delete_product,
            commands_food::get_expiring_products,
            commands_food::get_recipe,
            commands_food::plan_meal,
            commands_food::get_meal_plan,
            commands_food::delete_meal_plan,
            // Money
            commands_money::add_transaction,
            commands_money::get_transactions,
            commands_money::delete_transaction,
            commands_money::update_transaction,
            commands_money::get_transaction_stats,
            commands_money::create_budget,
            commands_money::get_budgets,
            commands_money::update_budget,
            commands_money::delete_budget,
            commands_money::create_savings_goal,
            commands_money::get_savings_goals,
            commands_money::update_savings_goal,
            commands_money::delete_savings_goal,
            commands_money::add_subscription,
            commands_money::get_subscriptions,
            commands_money::update_subscription,
            commands_money::delete_subscription,
            commands_money::add_debt,
            commands_money::get_debts,
            commands_money::update_debt,
            commands_money::delete_debt,
            // Blocklist
            ...
            // Data Flywheel
            commands_flywheel::get_flywheel_status,
            commands_flywheel::get_flywheel_history,
            commands_flywheel::run_flywheel_cycle,
            ...
            // Tab Page Blocks
            commands_flywheel::get_tab_blocks,
            commands_flywheel::save_tab_blocks,
            // MCP
            mcp::mcp_call_tool,
            mcp::mcp_list_tools,
            // Vacancy
            ...
            commands_flywheel::delete_body_record,
            commands_flywheel::get_body_zones_summary,
            commands_sports::get_exercises_by_body_zone,
            // Dashboard Widgets
