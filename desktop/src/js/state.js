...
export const TAB_ICONS = {
  ...
  jobs:        _s('<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/>'),
  ...
  more:        _s('<circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/>'),
};
...
export const TAB_REGISTRY = {
  ...
  jobs:        { label: 'Jobs',        icon: TAB_ICONS.jobs, closable: true,  subTabs: [] },
  ...
  sports:      { label: 'Sports',      icon: TAB_ICONS.sports, closable: true,  subTabs: [] },
  health:      { label: 'Health',      icon: TAB_ICONS.health,  closable: true,  subTabs: [] },
  mindset:     { label: 'Mindset',     icon: TAB_ICONS.mindset, closable: true,  subTabs: [] },
