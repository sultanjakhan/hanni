...
import { renderCloudRelaySection, wireCloudRelayControls } from './settings-cloud-relay.js';
...
async function renderSyncSection() {
  return renderCloudRelaySection({ mobile: IS_MOBILE });
}

function wireSyncControls(el) {
  void wireCloudRelayControls(el, invoke);
}
